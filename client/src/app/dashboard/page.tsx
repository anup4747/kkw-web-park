    ...
    <div className="bg-gradient-to-br from-slate-50 to-slate-100 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-8">
          ...
          <div className="relative bg-slate-100 rounded-lg p-6 min-h-[500px]">
            ...
            <div className="relative w-full h-96 bg-gradient-to-br from-emerald-50 to-teal-50 border-4 border-emerald-300 rounded-lg mx-auto">
                ...
                {Array.from({ length: 20 }, (_, i) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-6 h-6 rounded border-2 border-slate-400 flex items-center justify-center text-white text-xs hover:scale-110 transition-transform ${getSpotColor(spot!)}`}
                      title={`Upper Side Spot ${i + 1}`}
                    >
                      {getSpotIcon(spot!)}
                    </button>
                  );
              ...
              {/* Labels */}
              <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 text-sm font-semibold text-slate-700">
                Upper Side (20 Cars)
              </div>
              <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-sm font-semibold text-slate-700">
                Lower Side (20 Cars)
              </div>
              <div className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-16 text-sm font-semibold text-slate-700" style={{writingMode: 'vertical-rl'}}>
                Faculty Area (6 Spots)
              </div>
              <div className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-16 text-sm font-semibold text-slate-700" style={{writingMode: 'vertical-rl'}}>
                Bus Terminal (4 Spots)
              </div>
            </div>
            ...
            <div className="mt-10 flex flex-wrap gap-6 justify-center">
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-green-200 rounded border border-slate-400"></div>
                <span className="text-sm text-slate-600">Available</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-red-500 rounded border border-slate-400"></div>
                <span className="text-sm text-slate-600">Occupied (Cars)</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-blue-500 rounded border border-slate-400"></div>
                <span className="text-sm text-slate-600">Faculty</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-purple-500 rounded border border-slate-400"></div>
                <span className="text-sm text-slate-600">Buses</span>
              </div>
            </div>
          </div>
        </div>
